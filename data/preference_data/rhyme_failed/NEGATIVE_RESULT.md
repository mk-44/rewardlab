...
|---|---|
| [`../distill_bert/`](../../../experiments/reward/rhyme_failed/distill_bert/) | `distilbert-base-uncased`, full finetune, prompt + response |
| [`../probe_minilm/`](../../../experiments/reward/rhyme_failed/probe_minilm/) | `all-MiniLM-L6-v2`, backbone frozen, linear head, response only |
...
Recorded in [`../../../data/preference_data/rhyme_failed/reports/split_report.json`](reports/split_report.json).
...
Configuration in [`../distill_bert/config.yaml`](../../../experiments/reward/rhyme_failed/distill_bert/config.yaml).
...
Configuration in [`../probe_minilm/config.yaml`](../../../experiments/reward/rhyme_failed/probe_minilm/config.yaml).
...
python -m rlhf resplit --config data/preference_data/rhyme_failed/data.yaml \
...
python -m rlhf audit   --config data/preference_data/rhyme_failed/data.yaml

# Tier 1, needs the embedding backend
python -m rlhf profile --config data/preference_data/rhyme_failed/data.yaml

# Tier 2, the two training runs
python -m rlhf train --config experiments/reward/rhyme_failed/distill_bert/config.yaml \
    --set run_name=20260902_0033_e2_base
python -m rlhf train --config experiments/reward/rhyme_failed/probe_minilm/config.yaml \
    --set run_name=20260902_2343_e3_probe

# Evaluation and the prediction-versus-outcome ledger
python -m rlhf eval   --config experiments/reward/rhyme_failed/probe_minilm/config.yaml \
    --set run_name=20260902_2343_e3_probe
python -m rlhf ledger --config experiments/reward/rhyme_failed/probe_minilm/config.yaml \
    --set run_name=20260902_2343_e3_probe
```
...
| File | Contents |
|---|---|
| [`../../../data/preference_data/rhyme_failed/reports/audit_report.txt`](reports/audit_report.txt) | Tier 0, section 2 |
| [`../../../data/preference_data/rhyme_failed/reports/profile_report.txt`](reports/profile_report.txt) | Tier 1, section 3 |
| [`../distill_bert/20260902_0033_e2_base/tier2_report.txt`](../../../experiments/reward/rhyme_failed/distill_bert/20260902_0033_e2_base/tier2_report.txt) | Tier 2 A, section 4 |
| [`../probe_minilm/20260902_2343_e3_probe/tier2_report.txt`](../../../experiments/reward/rhyme_failed/probe_minilm/20260902_2343_e3_probe/tier2_report.txt) | Tier 2 B, section 5 |
| [`../distill_bert/ledger.md`](../../../experiments/reward/rhyme_failed/distill_bert/ledger.md), [`../probe_minilm/ledger.md`](../../../experiments/reward/rhyme_failed/probe_minilm/ledger.md) | Predictions versus outcomes |
